    ...
    public function load(ObjectManager $manager)
    {
        ...
        for ($i = 1; $i <= 150; $i++) {
            ...
            $product->setName('title_'.$i)
                ...
                ->setExpertComment(
                    'У нас такая же модель, только с мешком для сбора пыли. Выбрали мешковой, т.к. в нем мощность немного выше. Пылесосом очень довольны. Все функции выполняет на 5 с плюсом! Работает тихо и качественно.'
                )
