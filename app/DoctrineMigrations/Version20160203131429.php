...
class Version20160203131429 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_shop_price ADD CONSTRAINT FK_9EB927A04584665A FOREIGN KEY (product_id) REFERENCES product (id)');
        $this->addSql('ALTER TABLE product_shop_price ADD CONSTRAINT FK_9EB927A04D16C4DD FOREIGN KEY (shop_id) REFERENCES shop (id)');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE product_shop_price DROP FOREIGN KEY FK_9EB927A04D16C4DD');
