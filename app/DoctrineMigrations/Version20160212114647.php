...
class Version20160212114647 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE rating_settings ADD rating1weight INT DEFAULT 25, ADD rating2weight INT DEFAULT 25, ADD rating3weight INT DEFAULT 25, ADD rating4weight INT DEFAULT 25');
    }
