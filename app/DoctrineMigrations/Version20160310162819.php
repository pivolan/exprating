...
class Version20160310162819 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE invite ADD CONSTRAINT FK_C7E210D7733D5B5D FOREIGN KEY (curator_id) REFERENCES fos_user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE invite ADD CONSTRAINT FK_C7E210D7C5568CE4 FOREIGN KEY (expert_id) REFERENCES fos_user (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE seo ADD CONSTRAINT FK_6C71EC3012469DE2 FOREIGN KEY (category_id) REFERENCES category (slug) ON DELETE CASCADE');
